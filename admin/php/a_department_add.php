...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($department_name)) {
        ...
        // Prepare SQL to insert new department
        $stmt = $conn->prepare("INSERT INTO departments (department_name) VALUES (?)");
        $stmt->bind_param("s", $department_name);

        if ($stmt->execute()) {
            // Alert success and redirect
            echo "<script>alert('Department successfully added!'); window.location.href = 'a_department.php';</script>";
        } else {
...
<html lang="en">
    <head>
        ...
        <title>Inventory Management | Add Department</title>
                ...
                <div class="container">
                    ...
                    <form class="department-form" method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" name="department_name" id="department_name" required oninput="capitalizeFirstLetter(this)">
                        </div>
