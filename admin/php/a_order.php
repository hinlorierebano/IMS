...
<head>
    ...
    <script>
        ...
        function filterOrders() {
            ...
            window.location.href = "a_order.php?department=" + department + "&status=" + status + "&sortOrder=" + sortOrder;
        }
        ...
        <main class="main-content">
            ...
            <div class="container">
                <div class="header">
                    ...
                    <div class="right-section">
                        ...
                        <button class="add-order" onclick="window.location.href='a_order_add.php'">Add Order</button>
                    </div>
                </div>
            ...
            <div id="deleteModal" class="modal">
                <div class="modal-content">
                    ...
                    <form method="POST" action="a_order_delete.php">
            ...
            <div id="statusModal" class="modal">
                <div class="modal-content">
                    ...
                    <form method="POST" action="a_order_status_update.php">
